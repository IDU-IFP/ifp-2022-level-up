...
# 함수 -----------------------------------------------------------
survey_dic = {"TR": 0, "RT": 1, "FC": 2,
              "CF": 3, "MJ": 4, "JM": 5, "NA": 6, "AN": 7}
positive_result = ["R", "C", "J", "A"]
negative_result = ["T", "F", "M", "N"]


def solution(survey, choices):
    result = [0 for _ in range(8)]
    for i in range(len(survey)):
        result[survey_dic[survey[i]]] += choices[i]-4
    answer = ''
    for i in range(4):
        answer += positive_result[i] if result[(2*i)] - \
            result[(2*i)+1] >= 0 else negative_result[i]
    return answer
